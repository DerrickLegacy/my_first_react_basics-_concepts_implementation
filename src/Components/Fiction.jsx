                        ...
                        <Card sty le={{ width: '100%' }}>
                            ...
                            <Card.Body>
                                ...
                                <Card.Subtitle >
                                    ...
                                    <Container style={{ borderBottom: '1px solid #c9c9c9', fontWeight: 'normal' }}>
                                        <Stack direction="horizontal" gap={3}>
                                            ...
                                            <div className="p-2 ms-auto"><Dropdown>
                                                ...
                                                <Dropdown.Menu>
                                                    <Dropdown.Item onClick={() => handleSort('alphabetically')}>A-Z</Dropdown.Item>
                                                    <Dropdown.Item onClick={() => handleSort('id')}>By Id</Dropdown.Item>

                                                </Dropdown.Menu>
                                            </Dropdown></div>
                                            <div className="p-2 ms-auto">View {' '}
                                                <HiViewList size={30} />
                                ...
                                <Container>
                                    <Row style={{ borderLeft: '1px solid #c9c9c9', borderBottom: '0.4px  solid #c9c9c9', borderRight: '1px solid #c9c9c9', }}>

                                        {
                                            images.map((image) => {
                    
                                                const description = "This document is part of the source library for NRGI's 2021 Resource Governance Index, a comprehensive measure of the quality of natural resource governance in oil, gas and mineral - rich countries.To access the full dataset and all other index resources, visit https://resourcegovernanceindex.org."
                                                ...
                                                return (
                                                    <>
                                                        <Col sm={6}  >
                                                            <Card style={{ height: '85vh', margin: '15px 0px' }}>
                                                                <Card.Img variant="top" className='resource_image' alt='Image load failure' key={image.id} style={{ height: '30vh', borderBottom: '1px solid #c9c9c9' }} src={image.url} />
                                                                <Card.Body>
                                                                    <Card.Text>
                                                                        <h4>
                                                                    ...
                                                                    {/* <div> */}
                                                                        <p>
                                                                            This Handbook containing an up-to-date reproduction of Uganda's principal tax laws is intended for use by Tax Administrators, Tax. Practitioners, Taxpayers, ...</p>
                                                                    {/* </div> */}
